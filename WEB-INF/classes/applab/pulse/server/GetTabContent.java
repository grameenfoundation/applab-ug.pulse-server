    ...
    private void sendResponse(String request, String phoneId, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            response.getWriter().write(
                    "There was a problem accessing this tab content. Please try again later or contact an administrator.");
        }
    }

    private boolean sendErrorMessage(String phoneId, HttpServletResponse response) throws Exception {
